...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.001)  # Learning rate resnet:1e-4
    ...
    parser.add_argument('--train_list', type=str, default='./train.lst')
    parser.add_argument('--pre_model', type=str, default=None)

    # Testing settings
    parser.add_argument('--model', type=str, default='checkpoints/demo-15/best_result.pth')  # Snapshot
    ...
    parser.add_argument('--test_list', type=str, default='./test/test.lst')
